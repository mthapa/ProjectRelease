...
namespace ProjectRelease.Controllers
{
    public class AgenciesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AgencyId,AgencyCode,Name")] Agency agency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AgencyId,AgencyCode,Name")] Agency agency)
        {
            if (ModelState.IsValid)
            {
